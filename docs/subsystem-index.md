...
| `Lobby`, `LobbyManager`, `ILobby`, `LobbyMemberInfo`                                                                                                                                        | Lobby state. All eight server routes are implemented; no lobby can be created on the server yet, because the friends list the server sends is empty, so there is nobody to invite.                                                                           | OK                        |
